...
class cmdhelp(commands.Cog):
    ...
    def _build_categories(self):
        META = {
                ...
                'boutique': {'emoji': '🛒', 'title': 'Boutique'},
                'birthdays': {'emoji': '🎂', 'title': 'Anniversaires'},
                'tempvoice': {'emoji': '🎙️', 'title': 'Vocaux temporaires'},
                'statschannels': {'emoji': '📊', 'title': 'Salons de statistiques'},
                'socialalerts': {'emoji': '🔔', 'title': 'Alertes sociales'},
                'embeds': {'emoji': '🗒️', 'title': 'Embeds & émojis'},
                'achievements': {'emoji': '🏅', 'title': 'Succès & automatisations'},
                'starboard': {'emoji': '🌟', 'title': 'Starboard'},
                'poll': {'emoji': '🗳️', 'title': 'Sondages'},
                'custom': {'emoji': '✏️', 'title': 'Commandes personnalisées'},
                'twitch': {'emoji': '🟣', 'title': 'Twitch'},
                'i18n': {'emoji': '🌍', 'title': 'Traduction'},
